...
alias aws='/home/mmsa/aws-cli-bin/aws'
alias tmux='tmux -2'
...
#export PATH="${HOME}/.config/lsp/lua-language-server/bin/lua-language-server"

# to support zsh highlight in terminal
# todo: this makes code comments be grey highlighted (undesired)
#if [ ! "$TMUX" = "" ]; then export TERM=xterm-256color; fi
#export TERM=screen-256color #TODO: not working ,alacritty is not installed in wsl
...
if [ -f '/home/mmsa/google-cloud-sdk/path.zsh.inc' ]; then . '/home/mmsa/google-cloud-sdk/path.zsh.inc'; fi

# The next line enables shell command completion for gcloud.
if [ -f '/home/mmsa/google-cloud-sdk/completion.zsh.inc' ]; then . '/home/mmsa/google-cloud-sdk/completion.zsh.inc'; fi
